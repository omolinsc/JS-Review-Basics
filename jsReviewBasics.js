...
function rollDice(num) {
    return "El dado de " + num + " caras, ha sacado el número: " + (Math.floor(Math.random() * (num+1))); 
}
...
const array6 = ['Mesirve', 'Cristiano Romualdo', 'Fernando Muralla', 'Ronalguiño'];
